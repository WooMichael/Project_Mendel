import os
import sys
hmmdb_path = "~/Github/Project_Mendel/Data/Family_Database"
...
output_from_search = "~/Github/Project_Mendel/Data/MSA_Scans_From_nhmmerscan/"
counter = 0
for seq in output:
    #print(seq)
...
print("Scans are in please go into this folder to view each individual hits of each sequence that was queried in the database...")
