...
stream = os.popen('ls /home/ubuntu/Github/Project_Mendel/Data/Genera_Search_Data/Aligned_Reference_Sequences_From_LTP_Genera/')
...
for fam in output:
    ...
    for gen in gen_output:
        ...
        hmm_build_path = dir_gen_path + hmm_gen
